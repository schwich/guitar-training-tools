    ...
    return (
      <div style={{ display: "flex" }}>
        ...
        <main className={classes.content}>
          ...
          <Switch>
            <Route
              path="/guitar-scale-display"
              component={GuitarScaleDisplay}
            />
            <Route
              path="/guitar-chord-display"
              component={GuitarChordDisplay}
            />
            <Route
              path="/guitar-fretboard-trainer"
              component={GuitarFretboardTrainer}
            />
