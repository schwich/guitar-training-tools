        ...
        return (
            <Paper style={{padding: 10}}>
                <div>
                    ...
                    <Button 
                        onClick={() => {this.handlePatternBtnClick(ShapeButton.Prev)}} 
                        variant="contained">Prev Shape</Button>
                    <Button 
                        onClick={() => {this.handlePatternBtnClick(ShapeButton.Next)}} 
                        variant="contained">Next Shape</Button>
                </div>
            </Paper>
        )
    }
