...
export default class GuitarFretboardTrainer extends React.Component<
  Props,
  State
> {
  ...
  handleStartGameBtn = () => {
    ...
    if (this.gameController) {
      this.gameController.startNewGame(this.state.includeAccidentals);
  ...
  handleNoteClicked = (stringNum: number, noteClicked: string[]) => {
    ...
    if (this.gameController) {
      let answerResponse = this.gameController.checkAnswer(
        stringNum,
        noteClicked
      ); // update game state
      ...
      <div id="mainContainer">
        <div style={{ display: "flex" }}>
          ...
          <FretboardControlPanel
            ...
            handleIncludeAccidentals={this.handleIncludeAccidentals}
          />
